...
road_name = "Road4"
direction_max, direction_min, direction_mean, direction_std, speed_max, speed_min, speed_mean, speed_std, mean_image, std_image, img_max, img_min, diff = pickle.load(open(root_directory+"HybridRegressionRGB3ImageTrainer("+road_name+")_important_data.dat","r"))
...
train_saver.restore(sess, root_directory+"Trained_NN/HybridRegressionRGB3Image"+road_name)
j = 0
...
dosya.write("HybridRegressionRGB3ImageTest %f" % j + "\n")
dosya.close()
print "Loss : ", j
