...
road_name = "Road4"
direction_max, direction_min, direction_mean, direction_std, speed_max, speed_min, speed_mean, speed_std, mean_image, std_image, img_max, img_min, diff = pickle.load(open(root_directory+"CNNRegression3ImageTrainer("+road_name+")_important_data.dat", "r"))
...
# Load trained model...
train_saver.restore(sess, root_directory + "Trained_NN/CNNRegression3Image"+road_name)
...
dosya.write("CNNRegression3ImageTest %f" % j + "\n")
dosya.close()
