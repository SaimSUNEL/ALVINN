...
pickle.dump([direction_max, direction_min,
             ...
             whole_image_set.min(), diff], open("HybridRegressionRGB3ImageSingleInputTrainer("+road_name+")_important_data.dat", "w"))
...
error_graph_file_name = "HybridRegressionRGB3ImageSingleInput"+road_name+"_graph.dat"
...
if len([file for file in os.listdir("Trained_NN") if file.__contains__("HybridRegressionRGB3ImageSingleInput"+road_name)]) > 0:
    # Load previously saved model...

    train_saver.restore(sess, "Trained_NN/HybridRegressionRGB3ImageSingleInput"+road_name)
    ...
    print "Smallest  validat : ", smallest_validation_error
else:
...
while iteration_count != 0:
    ...
    for iteration in range(iteration_count):
        ...
        if j < smallest_validation_error:
            ...
            train_saver.save(sess, "Trained_NN/HybridRegressionRGB3ImageSingleInput" + road_name)
