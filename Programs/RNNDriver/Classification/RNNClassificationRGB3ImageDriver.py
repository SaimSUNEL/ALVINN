...
direction_max, direction_min, direction_mean, direction_std, speed_max, speed_min, speed_mean, speed_std, mean_image, std_image, img_max, img_min, diff = pickle.load(open("RNNClassificationRGB3ImageTrainer_important_data.dat","r"))
    ...
    while True:
        ...
        if vehicle_image is not None:
            if image_count < 2:
                ...
                combination = np.reshape(combination, (9, 10000))
...
rospy.init_node("RNNClassificationRGB3ImageDriver", anonymous=False)
