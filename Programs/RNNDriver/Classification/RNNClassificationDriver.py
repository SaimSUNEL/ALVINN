...
direction_max, direction_min, direction_mean, direction_std, speed_max, speed_min, speed_mean, speed_std, mean_image, std_image, img_max, img_min, diff = pickle.load(open("RNNClassificationTrainer_important_data.dat","r"))
...
rospy.init_node("RNNClassificationDriver", anonymous=False)
