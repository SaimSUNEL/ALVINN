...
# Loading speed, direction angle of validation set...
road_name = "Road4"
...
# Loading speed, direction angle info of training set...
data_dictionary = {}
camera_image_size = 100
# v = (v-min)/(max-min)
direction_data = []
...
# Loading training images of training set...
information_set = []
information_set2 = []
whole_image_set = []
road_name = "Road4"
...
pickle.dump([direction_max, direction_min,
             ...
             whole_image_set.min(), diff], open("RNNRegression3ImageTrainer("+road_name+")_important_data.dat", "w"))
...
# Stacking 3 consequtive images of validation set into one...
...
for image_index in range(2, len(validation_image_set)):
    ...
    combinatination = np.reshape(combinatination, newshape=(30, 1000))
...
# Stacking 3 consequtive images of training set into one...
...
error_graph_file_name = "RNNRegression3Image"+road_name+"_graph.dat"
...
if len([file for file in os.listdir("Trained_NN") if file.__contains__("RNNRegression3Image"+road_name)]) > 0:
...
while iteration_count != 0:
    ...
    for iteration in range(iteration_count):
        ...
        if j < smallest_validation_error:
            ...
            train_saver.save(sess, "Trained_NN/RNNRegression3Image" + road_name)
