...
# It is supplied to RNN as 90 timesteps and each time step input is 1000
...
# Statistics of direction, speed of validation set...
...
# Loading speed, direction of training set...
data_dictionary = {}
camera_image_size = 100
# v = (v-min)/(max-min)
direction_data = []
...
#Statistic of speed and direction angle of training data set...
...
pickle.dump([direction_max, direction_min,
             ...
             whole_image_set.min(), diff], open("RNNRegressionRGB3ImageTrainer("+road_name+")_important_data.dat", "w"))
...
# Stacking 3 sequential RGB images of validation set into one...
...
error_graph_file_name = "RNNRegressionRGB3Image"+road_name+"_graph.dat"
...
if len([file for file in os.listdir("Trained_NN") if file.__contains__("RNNRegressionRGB3Image"+road_name)]) > 0:
    train_saver.restore(sess, "Trained_NN/RNNRegressionRGB3Image"+road_name)
...
while iteration_count != 0:
    ...
    for iteration in range(iteration_count):
        ...
        if j < smallest_validation_error:
            ...
            train_saver.save(sess, "Trained_NN/RNNRegressionRGB3Image" + road_name)
