...
direction_max, direction_min, direction_mean, direction_std, speed_max, speed_min, speed_mean, speed_std, mean_image, std_image, img_max, img_min, diff = \
    pickle.load(open("RNNRegressionRGB3ImageTrainer("+road_name+")_important_data.dat","r"))
    ...
    while True:
        ...
        if vehicle_image is not None:
            if image_count < 2:
                ...
                print "Current angle : ", curr_angle, " Curr speed : ", curr_speed
...
rospy.init_node("RNNRegressionRGB3ImageDriver", anonymous=False)
